...
const LaunchInfo: FC<any>= ({launch, launcher}) => {
    ...
    return(<motion.div key={launch.id} variants={variants} whileHover="hover" initial="rest" className="bg-gradient-to-r from-blue-500 to-blue-900 w-full rounded-3xl text-white ">
    <motion.div className="grid place-content-center w-full text-white p-10 gap-6">
        ...
        <div className="flex flex-wrap gap-4 place-content-center">
            <h1 className="text-center font-medium text-xl">Active: {launcher.active == true ? <span className="text-green-600">Yes</span>: <span className="text-red-500">No</span>}</h1>
